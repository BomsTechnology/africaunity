...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mx-auto min-h-screen w-full bg-white py-4 lg:px-20 xl:w-[90%]" }, _attrs))}><div class="w-full space-y-4 py-5 text-center"><h1 class="text-4xl font-bold capitalize text-primary-blue">${ssrInterpolate(_ctx.$t("add"))} ${ssrInterpolate(__props.type)}</h1><h2 class="text-md text-gray-700">${ssrInterpolate(_ctx.$t("your"))} ${ssrInterpolate(__props.type)} ${ssrInterpolate(_ctx.$t("add-desc-1"))}</h2><div class="flex flex-col items-center justify-center lg:flex-row lg:space-x-3"><h1 class="font-semibold">${ssrInterpolate(_ctx.$t("select-lang"))} :</h1><div class="mt-3 flex space-x-3 lg:mt-0"><button class="${ssrRenderClass([
      ...
      _push(`<h1 class="text-xl font-semibold">${ssrInterpolate(_ctx.$t("add"))} ${ssrInterpolate(__props.type)}</h1><h2 class="text-md font-light text-gray-700">${ssrInterpolate(_ctx.$t("good-msg-post"))} ! </h2><form id="postform" enctype="multipart/form-data"><div class="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2"><div class="col-span-2"><label class="dark:text-gray-200 text-gray-700">${ssrInterpolate(_ctx.$t("title"))} <span class="text-red-500">*</span></label><input required${ssrRenderAttr("value", post.title)} maxlength="50" type="text" class="dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:focus:border-blue-300 mt-2 block w-full rounded-md border border-gray-200 bg-white px-4 py-2 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"><span class="text-xs font-light text-gray-400">${ssrInterpolate(post.title.length)} of 50 Characters</span></div><div class="col-span-2 lg:col-span-1"><label class="dark:text-gray-200 text-gray-700" for="es">${ssrInterpolate(_ctx.$t("continent"))} <span class="text-red-500">*</span></label><select required class="form-select mt-2 block w-full rounded-md border border-gray-200 bg-white px-4 py-2 text-gray-700 focus:border-primary-blue focus:outline-none focus:ring-primary-blue"><!--[-->`);
      ...
      if (__props.type == "article") {
        _push(`<div class="col-span-2"><label class="dark:text-gray-200 text-gray-700" for="fr">${ssrInterpolate(_ctx.$t("thumbnails"))} <span class="text-red-500">*</span></label><input required accept="image/*" type="file" class="dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:focus:border-blue-300 mt-2 block w-full rounded-md border border-gray-200 bg-white px-4 py-2 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (__props.type == "article") {
        ...
        _push(`<div><textarea required maxlength="2000" class="dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:focus:border-blue-300 mt-2 block h-32 w-full rounded-md border border-gray-200 bg-white px-4 py-2 text-gray-700 focus:border-primary-blue focus:outline-none focus:ring focus:ring-primary-blue focus:ring-opacity-40">${ssrInterpolate(post.content)}</textarea><span class="text-xs font-light text-gray-400">${ssrInterpolate(post.content.length)} of 2000 Characters</span></div>`);
      }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/views/front/AddPost.vue");
