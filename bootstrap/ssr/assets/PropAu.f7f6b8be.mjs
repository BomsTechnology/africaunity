import { mergeProps, useSSRContext, ref, reactive, onMounted, onUnmounted, resolveComponent, unref, withCtx, createVNode, toDisplayString, createTextVNode } from "vue";
...
import { PlusCircleIcon, UserIcon, CalendarIcon, ChatIcon, EmojiSadIcon } from "@heroicons/vue/solid";
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/components/skeleton/PropAu.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mx-auto flex min-h-screen w-full flex-col-reverse bg-white p-4 text-lg md:space-y-2 lg:flex-row lg:space-x-2 xl:w-[90%]" }, _attrs))}><div class="lg:w-[70%]"><h1 class="text-center text-5xl font-bold capitalize text-primary-blue">${ssrInterpolate(_ctx.$t("propau"))}</h1><div class="flex justify-end px-6">`);
        ...
        _push(ssrRenderComponent(_component_router_link, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<p class="text-base leading-4"${_scopeId}>${ssrInterpolate(_ctx.$t("add"))} PropAU</p>`);
            } else {
              return [
                createVNode(unref(PlusCircleIcon), { class: "h-6 w-6" }),
                createVNode("p", { class: "text-base leading-4" }, toDisplayString(_ctx.$t("add")) + " PropAU", 1)
              ];
            }
          }),
          _: 1
      ...
      if (unref(loading) == 3) {
        ...
        ssrRenderList(unref(posts), (post) => {
          _push(`<div class="dark:bg-gray-800 overflow-hidden rounded-lg bg-white shadow-md"><div class="p-6"><div><a href="#" class="rounded py-1 px-2 text-xs capitalize text-white" style="${ssrRenderStyle("background:" + post.ministry.color)}">`);
          ...
          _push(`<p class="dark:text-gray-400 mt-2 text-sm text-gray-600">${ssrInterpolate(post.content.substring(0, 19) + "...")}</p></div><div class="mt-4 flex items-center justify-between text-sm">`);
          _push(ssrRenderComponent(_component_router_link, {
            to: {
              name: "show.post",
              params: { id: post.id }
      ...
      _push(`</div><div class="bg-white lg:w-[30%]"><div class="z-0 w-full bg-white"><h1 class="inline-block bg-primary-blue px-2 py-1 text-white">${ssrInterpolate(_ctx.$t("filter-propau"))}</h1><form><div class="text-md space-y-2 border-t-2 border-primary-blue p-4"><div><label class="text-xs text-gray-500">${ssrInterpolate(_ctx.$t("language"))}</label><select class="form-select mt-2 block w-full border-gray-300 px-3 py-2 text-xs focus:border-primary-blue focus:ring-primary-blue"><option value="fr">${ssrInterpolate(_ctx.$t("fr"))}</option><option value="en">${ssrInterpolate(_ctx.$t("en"))}</option><option value="es">${ssrInterpolate(_ctx.$t("es"))}</option><option value="pt">${ssrInterpolate(_ctx.$t("pt"))}</option></select></div><div><label class="text-xs text-gray-500">${ssrInterpolate(_ctx.$t("key-words"))}</label><input type="text"${ssrRenderAttr("value", filter.keywords)}${ssrRenderAttr("placeholder", _ctx.$t("key-words"))} class="form-input mt-2 block w-full border-gray-300 px-3 py-2 text-xs focus:border-primary-blue focus:ring-primary-blue"></div><div><label class="text-xs text-gray-500">${ssrInterpolate(_ctx.$t("continent"))}</label><select class="form-select mt-2 block w-full border-gray-300 px-3 py-2 text-xs focus:border-primary-blue focus:ring-primary-blue"><option value="">--------------</option><!--[-->`);
      ...
      _push(`<!--]--></select></div><div><label class="text-xs text-gray-500">${ssrInterpolate(_ctx.$t("zoned"))}</label><select class="form-select mt-2 block w-full border-gray-300 px-3 py-2 text-xs focus:border-primary-blue focus:ring-primary-blue"><option value="">--------------</option>`);
      ...
      _push(`</select></div><div><label class="text-xs text-gray-500">${ssrInterpolate(_ctx.$t("country"))}</label><select class="form-select mt-2 block w-full border-gray-300 px-3 py-2 text-xs focus:border-primary-blue focus:ring-primary-blue"><option value="">--------------</option>`);
      ...
      _push(`</select></div><div><label class="text-xs text-gray-500">${ssrInterpolate(_ctx.$t("ministry"))}</label><select class="form-select mt-2 block w-full border-gray-300 px-3 py-2 text-xs focus:border-primary-blue focus:ring-primary-blue"><option value="">--------------</option><!--[-->`);
      ...
      if (unref(loading) == 0 || unref(loading) == 2) {
        _push(`<button type="submit" class="mt-6 w-full bg-primary-blue px-8 py-2 text-lg text-white">${ssrInterpolate(_ctx.$t("filter"))}</button>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(loading) == 1) {
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/views/front/PropAu.vue");
