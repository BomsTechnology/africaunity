import { ref, onMounted, resolveComponent, mergeProps, withCtx, unref, createVNode, createTextVNode, toDisplayString, useSSRContext } from "vue";
...
const _sfc_main = {
  __name: "MinistryIndex",
  __ssrInlineRender: true,
  setup(__props) {
    const { ministries, getMinistries, destroyMinistry, loading, errors } = useMinistries();
    ref("");
    onMounted(async () => {
      await getMinistries();
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative h-auto w-full xl:mt-0 xl:p-4" }, _attrs))}><div class="z-0 h-full w-full p-4"><div class="flex justify-between bg-white px-8 py-5 shadow-lg"><h1 class="text-4xl font-bold text-primary-blue">Ministry</h1>`);
      _push(ssrRenderComponent(_component_router_link, {
        to: { name: "admin.ministry.create" },
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<p class="text-base leading-4"${_scopeId}>Add Ministry</p>`);
          } else {
            return [
              createVNode(unref(PlusCircleIcon), { class: "h-6 w-6" }),
              createVNode("p", { class: "text-base leading-4" }, "Add Ministry")
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_EasyDataTable, {
        ...
        "item-color": withCtx((item, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="h-1 w-full rounded-full border p-2" style="${ssrRenderStyle("background:" + item.color)}"${_scopeId}></span>`);
          } else {
            return [
              createVNode("span", {
                class: "h-1 w-full rounded-full border p-2",
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", null, [
                ...
                createVNode("button", {
                  onClick: ($event) => deleteMinistry(item.id),
                  type: "button",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/views/back/ministry/MinistryIndex.vue");
