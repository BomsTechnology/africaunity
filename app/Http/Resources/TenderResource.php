...
class TenderResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'activity_areas' => ActivityAreaResource::collection(Tender::find($this->id)->activity_areas()->orderBy('id')->get()),
            'languages' => LanguageResource::collection(Tender::find($this->id)->languages()->orderBy('id')->get()),
