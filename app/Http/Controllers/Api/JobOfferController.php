...
class JobOfferController extends Controller
{
    ...
    public function jobOffers_apply(Request $request)
    {
        ...
        $authorUser = User::find($job->user_id);
         ...
         $filename = '/uploads/jobs/cv/' . str_replace(" ", "_", $job->title ). '_' . str_replace(" ", "_", $applyUser->firstname) . '_' . time() . '.' . $request->file('cv')->extension();
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('company_logo')) {
            ...
            $filename = '/uploads/jobs/logo/' . time() . '.' . $request->file('company_logo')->extension();
