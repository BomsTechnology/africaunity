                    ...
                    <div class="p-6">
                        <div class="container">
                                ...
                                >
                                    ...
                                    <div class="flex space-x-1" v-if="post.user!=null" >
                                ...
                                <div :class="{ 'blurred': user.id==null }">
                                    <p
                                        class="my-4 mt-2 py-4 text-gray-600 break-words"
                                        v-html="post.content"
                                    ></p>
                                </div>
                            <div class="pt-6 text-center login" v-if="user.id==null">
                                <router-link
                        ...
                        <div class="mt-4">
                            <div class="flex items-center justify-between" v-if="post.user!=null">
                                <router-link
                                    :to="{
                                        name: 'compte',
                                        params: {
...
const { post, getPostShared, loading } = usePosts();
const { errors, } = useComments();
