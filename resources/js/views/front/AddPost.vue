        ...
        <form  @submit.prevent="storePost()" id="postform" enctype="multipart/form-data">
            <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                <div class="col-span-2">
                    ...
                    <span class="text-xs font-light text-gray-400">{{ post.title.length }} of 50 Characters</span>
                </div>

                <div class="lg:col-span-1 col-span-2">
                    <label class="text-gray-700 dark:text-gray-200" for="es">{{ $t('continent') }} <span class="text-red-500">*</span></label>
