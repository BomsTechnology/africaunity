                                    ...
                                    >
                                        ...
                                        >
                                           ...
                                           <td
                                            ...
                                            >
                                                <router-link :to="{name:'admin.announcement.edit', params: { id: announcement.id }}"
                                                    href="#"
...
export default {
    ...
    setup(props) {
        const { announcements, getAnnouncements, destroyAnnouncement, loading, errors } = useAnnouncements();
