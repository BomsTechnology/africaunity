    ...
    <div class="relative h-auto w-full xl:mt-0 xl:p-4">
        <div class="z-0 h-full w-full p-4">
            <div class="flex justify-between bg-white px-8 py-5 shadow-lg">
                <h1 class="text-4xl font-bold text-primary-blue">Ministry</h1>
                <router-link
                ...
                >
                    ...
                    <p class="text-base leading-4">Add Ministry</p>
                </router-link>
            </div>
                        ...
                        <div class="overflow-hidden">
                            ...
                            >
                                ...
                                <tbody
                                    ...
                                    v-if="filteredMinistry.length != 0"
                                >
                                    <tr
                                        v-for="ministry in filteredMinistry"
                                        :key="ministry.id"
...
const filteredMinistry = computed(() => {
    return ministries.value.filter((ministry) => {
        return ministry.name_fr
            .toLowerCase()
