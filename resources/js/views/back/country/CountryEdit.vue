...
export default {
    ...
    setup(props) {
        ...
        const { updateCountry, getCountry, errors, loading, country } =
            useCountries();
        onMounted(getCountry(props.id), getContinents(), getZones());
        ...
        filteredZone() {
            if (this.country.zone) {
                return this.zones.filter((zone) => {
                    return zone.continent_id == this.country.zone.continent_id;
                });
            } else {
                return [];
            }
