...
<div class="flex">
  ...
  <div class="w-full xl:mt-0 mt-[74px] relative h-auto xl:p-4">
    ...
    <section class=" p-6 mx-auto bg-white shadow-md">
        ...
        <h2 class="text-md font-light text-gray-700">Add a new category Announcement</h2>
        <form @submit.prevent="storeCategoryAnnouncement()">
...
export default {
    ...
    setup() {
        ...
        const storeCategoryAnnouncement = async () => {
            await createCategoryAnnouncement({...categoryAnnouncement});
        }
