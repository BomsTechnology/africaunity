                            ...
                            <div class="overflow-hidden">
                                ...
                                >
                                    ...
                                    <tbody
                                        ...
                                        v-if="filteredCategoryAnnouncement.length != 0"
                                    >
                                        <tr
                                            v-for="categoryAnnouncement in filteredCategoryAnnouncement"
                                        ...
                                        >
                                            ...
                                            >
                                                {{ categoryAnnouncement.name }}
                                            </td>
                                            <td
                                                class="py-4 px-6 text-sm font-medium text-right whitespace-nowrap"
                                            >
                                                <router-link :to="{name:'admin.category.edit', params: { id: categoryAnnouncement.id }}"
                                                    href="#"
                                                    class="text-primary-blue dark:text-blue-500 hover:underline"
                                                    >Edit</router-link
                                                >
                                                <a
                                                    @click="deleteCategoryAnnouncement(categoryAnnouncement.id)"
                                                    href="#"
...
export default {
    ...
    setup() {
        const { categoryAnnouncements, getCategoryAnnouncements, destroyCategoryAnnouncement, loading, errors } =
            useCategoryAnnouncements();
        const searchKey = ref("");

        onMounted(getCategoryAnnouncements());
    ...
    computed: {
        filteredCategoryAnnouncement() {
            return this.categoryAnnouncements.filter((categoryAnnouncement) => {
                return categoryAnnouncement.name
                    .toLowerCase()
