                        ...
                        <div class="overflow-hidden">
                            ...
                            >
                                ...
                                <tbody
                                    ...
                                    v-if="
                                        filteredCategoryAnnouncement.length != 0
                                    "
                                >
                                    <tr
...
const filteredCategoryAnnouncement = computed(() => {
    return categoryAnnouncements.value.filter((categoryAnnouncement) => {
