                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <img v-if="jobOffer.company_logo" :src="jobOffer.company_logo" alt="" class="w-16 rounded-full h-16 object-cover">
                                                <OfficeBuildingIcon v-else class="w-12 h-12 " />
                                            </td>
                                            <td
                                                class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white"
                                            >
                                           ...
                                           <td
                                            ...
                                            >
                                                <router-link :to="{name:'admin.jobOffer.edit', params: { id: jobOffer.id }}"
                                                    href="#"
