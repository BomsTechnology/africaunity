    ...
    <div class="relative min-h-screen w-full bg-white xl:mt-0 xl:p-4">
        <div class="z-0 h-full w-full p-4">
            <div class="flex justify-between bg-white px-8 py-5">
                <h1 class="text-4xl font-bold text-primary-blue">Continent</h1>
                <router-link
                ...
                >
                    ...
                    <p class="text-base leading-4">Add Continent</p>
                </router-link>
            </div>
...
const deleteContinents = async () => {
    if (itemsSelected.value.length != 0) {
        ...
        if (confirm("I you Sure ?")) {
            await destroyContinent(deleteIds.value);
            if (errors.value == "") {
                await getContinents();
                itemsSelected.value = [];
            }
