...
<div class="flex">
  ...
  <div class="w-full xl:mt-0 mt-[74px] relative h-auto xl:p-4">
    ...
    <section class=" p-6 mx-auto bg-white shadow-md w-full">
        ...
        <h2 class="text-md font-light text-gray-700">Edit University </h2>
        <form  @submit.prevent="saveUniversity()" id="universityform" enctype="multipart/form-data">
