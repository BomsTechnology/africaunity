...
watch(props, async function (newProps, oldProps) {
    files.value = newProps.modelValue;
});
...
<template>
    <div class="w-full">
        <div
            :class="[
                isDrag
                    ? 'bg-secondary-color flex w-full flex-col items-center justify-center rounded border-2 border-dashed p-4 transition-colors'
